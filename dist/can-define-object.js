...
var _require = require("can-define-mixin"),
...
function (_mixinProxy) {
  _inherits(DefineObject, _mixinProxy);

  function DefineObject(props) {
    var _this;

    _classCallCheck(this, DefineObject);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(DefineObject).call(this));
